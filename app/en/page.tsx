    ...
    <main lang="en">
      ...
      <header className="site-header">
        ...
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-alhaurin-el-grande/">Holiday rental management</a>
              <a href="/midterm-verhuur-alhaurin-el-grande/">
                Seasonal and mid-term rentals
              </a>
              <a href="/langetermijnverhuur-alhaurin-el-grande/">Long-term rentals</a>
              <a href="/vastgoedbeheer-alhaurin-el-grande/">Property management</a>
              ...
              <a href="/verhuurlicentie-alhaurin-el-grande/">Rental licence</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Services</b>
            <a href="/vakantieverhuur-alhaurin-el-grande/">Holiday rental management</a>
            <a href="/midterm-verhuur-alhaurin-el-grande/">Seasonal and mid-term rentals</a>
            <a href="/langetermijnverhuur-alhaurin-el-grande/">Long-term rentals</a>
            <a href="/vastgoedbeheer-alhaurin-el-grande/">Property management</a>
            <a href="/schoonmaak-onderhoud-alhaurin-el-grande/">Cleaning & maintenance</a>
            <a href="/renovatie-inrichting-alhaurin-el-grande/">Renovation & furnishing</a>
            <a href="/verhuurlicentie-alhaurin-el-grande/">Rental licence</a>
            <b>Company</b>
            <a href="/werkwijze/">How we work</a>
            <a href="/over-ons/">About us</a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <h1>Enjoy your second home in Alhaurín el Grande. We take care of the rest.</h1>
          <p>
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <h2>Local knowledge across Alhaurín el Grande</h2>
          <p>
      ...
      <section className="contact" id="contact">
        <div>
          ...
          <h2>Get an informed rental forecast for Alhaurín el Grande</h2>
          <p>
