...
const faqs = [
  [
    "¿Cuánto cuesta la gestión de alquiler vacacional en Alhaurín el Grande?",
  ...
  [
    ...
    "Por supuesto. Bloqueamos tus estancias con antelación y adaptamos la estrategia a los periodos en que quieras visitar Alhaurín el Grande.",
  ],
  [
  ...
  [
    "¿En qué zonas de Alhaurín el Grande trabajáis?",
    "Ayudamos a propietarios en Alhaurín el Grande Pueblo, Villafranco del Guadalhorce, La Cala de Alhaurín el Grande, Cártama, Alhaurín de la Torre, Alhaurín el Grande Golf, Las Lagunas y Miraflores. Cada vivienda y ubicación se valora individualmente.",
  ],
  [
    "¿Necesito licencia turística para alquilar vacacionalmente en Alhaurín el Grande?",
...
function LocalizedHome() {
  ...
  const schema = {
    ...
    description:
      "Gestión integral de propiedades, alquiler vacacional y cuidado de segundas residencias para propietarios en Alhaurín el Grande.",
    parentOrganization: {
      "@type": "Organization",
    ...
    knowsAbout: [
      "Gestión de propiedades Alhaurín el Grande",
    ...
    <main lang="es">
      ...
      <header className="site-header">
        <a
          ...
          href="/"
          aria-label="Gestión de propiedades Alhaurín el Grande – Home"
        >
          <img
            src="/vbs-logo-alhaurin.webp"
            alt="Gestión de propiedades Alhaurín el Grande logo"
            width="54"
            height="54"
          />
        </a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <p>
            Desde Villafranco del Guadalhorce y La Cala hasta Alhaurín el Grande Pueblo, combinamos una gestión inteligente con profesionales locales de confianza. Tienes un único contacto para reservas, huéspedes, limpieza, mantenimiento y cuidado diario de la vivienda.
          </p>
        ...
        <div className="hero-stats">
          ...
          <span>
            <CheckCircle2 aria-hidden="true" />
            <b>Servicio local</b> in Alhaurín el Grande y alrededores
          </span>
        </div>
      </section>
      ...
      <section
        ...
        aria-label="Viviendas y propiedades en Alhaurín el Grande"
      >
        <figure className="showcase-wide">
          <img
            src="/villa-zwembad-alhaurin-el-grande.webp"
            alt="Villa moderna en Alhaurín el Grande con terraza, piscina y vistas al mar"
            width="1536"
            height="1024"
            loading="eager"
          />
        ...
        <figure>
          <img
            src="/villa-zwembad-alhaurin-el-grande.webp"
            alt="Vivienda vacacional en la costa de Alhaurín el Grande"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure>
          <img
            ...
            alt="Vivienda vacacional de lujo en Alhaurín el Grande con vistas al mar"
            width="1600"
            height="1200"
            loading="lazy"
          />
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <p>
            Desdeal apartments y golf townhouses hasta hillside villas, we work throughout Alhaurín el Grande Pueblo, La Cala de Alhaurín el Grande, Villafranco del Guadalhorce, Cártama, Miraflores, Alhaurín de la Torre y Alhaurín el Grande Golf.
          </p>
        </div>
        <div className="area-list" aria-label="Zonas atendidas alrededor de Alhaurín el Grande">
      ...
      <section className="home-team">
        <div className="home-team-copy">
          ...
          <h2>Contacto personal con profesionales que conocen Alhaurín el Grande.</h2>
          <p>
      ...
      <section className="knowledge compact-knowledge" id="kennisbank">
        <div className="section-head">
          ...
          <p>
            Información clara sobre costes, estrategia de alquiler, normativa y gestión de propiedades en Alhaurín el Grande.
          </p>
        </div>
      ...
      <section className="faq">
        <div>
          ...
          <p>
            Preguntas clave sobre nuestros servicios y tarifas en Alhaurín el Grande.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          <a className="logo-lockup" href="/" aria-label="Home">
            <img
              src="/vbs-logo-alhaurin.webp"
              alt="Gestión de propiedades Alhaurín el Grande"
              width={640}
              height={640}
              sizes="54px"
            />
          ...
          <p>
            Gestión de propiedades Alhaurín el Grande forma parte de{" "}
