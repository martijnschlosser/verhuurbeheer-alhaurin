...
const services = [
  {
    ...
    slug: "vakantieverhuur-alhaurin-el-grande",
  ...
  },
  {
    ...
    slug: "midterm-verhuur-alhaurin-el-grande",
  ...
  },
  {
    ...
    slug: "langetermijnverhuur-alhaurin-el-grande",
  ...
  },
  {
    ...
    slug: "vastgoedbeheer-alhaurin-el-grande",
    price: "Tailored",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    slug: "schoonmaak-onderhoud-alhaurin-el-grande",
  ...
  },
  {
    ...
    slug: "renovatie-inrichting-alhaurin-el-grande",
...
const faqs = [
  [
    "How much does holiday rental management in Alhaurín el Grande cost?",
  ...
  [
    ...
    "Of course. We block your own stays in advance and align the rental strategy with the periods when you want to visit Alhaurín el Grande.",
  ],
  [
  ...
  [
    "Which areas of Alhaurín el Grande do you cover?",
    "We support owners in Alhaurín el Grande Pueblo, Villafranco del Guadalhorce, La Cala de Alhaurín el Grande, Cártama, Alhaurín de la Torre, Alhaurín el Grande Golf, Las Lagunas and Miraflores. Every property and location is assessed individually.",
  ],
  [
    "Do I need a rental licence for holiday rentals in Alhaurín el Grande?",
...
function LocalizedHome() {
  ...
  const schema = {
    ...
    description:
      "Full-service property management, holiday rental management and second-home care for owners in Alhaurín el Grande.",
    parentOrganization: {
      "@type": "Organization",
    ...
    areaServed: [
      ...
      { "@type": "Place", name: "Alhaurín el Grande Pueblo" },
      { "@type": "Place", name: "Villafranco del Guadalhorce" },
      { "@type": "Place", name: "La Cala de Alhaurín el Grande" },
      { "@type": "Place", name: "Cártama" },
      { "@type": "Place", name: "Alhaurín de la Torre" },
      { "@type": "Place", name: "Alhaurín el Grande Golf" },
      { "@type": "Place", name: "Las Lagunas" },
    ...
    url: absoluteUrl("/es/"),
    logo: absoluteUrl("/vbs-logo-alhaurin.webp"),
    image: absoluteUrl("/terras-zonsondergang-alhaurin-el-grande.webp"),
    sameAs: [
    ...
    knowsAbout: [
      "Property Management Alhaurín el Grande",
    ...
    <main lang="es">
      ...
      <header className="site-header">
        <a
          ...
          href="/"
          aria-label="Property Management Alhaurín el Grande – Home"
        >
          <img
            src="/vbs-logo-alhaurin.webp"
            alt="Property Management Alhaurín el Grande logo"
            width="54"
            height="54"
          />
        </a>
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-alhaurin-el-grande/">Gestión de alquiler vacacional</a>
              <a href="/midterm-verhuur-alhaurin-el-grande/">
                Alquiler de temporada
              </a>
              <a href="/langetermijnverhuur-alhaurin-el-grande/">Alquiler de larga duración</a>
              <a href="/vastgoedbeheer-alhaurin-el-grande/">Gestión de propiedades</a>
              <a href="/schoonmaak-onderhoud-alhaurin-el-grande/">
                Limpieza y mantenimiento
              </a>
              <a href="/renovatie-inrichting-alhaurin-el-grande/">
                Reforma y decoración
              </a>
              <a href="/verhuurlicentie-alhaurin-el-grande/">Licencia de alquiler</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Servicios</b>
            <a href="/vakantieverhuur-alhaurin-el-grande/">Gestión de alquiler vacacional</a>
            <a href="/midterm-verhuur-alhaurin-el-grande/">Alquiler de temporada</a>
            <a href="/langetermijnverhuur-alhaurin-el-grande/">Alquiler de larga duración</a>
            <a href="/vastgoedbeheer-alhaurin-el-grande/">Gestión de propiedades</a>
            <a href="/schoonmaak-onderhoud-alhaurin-el-grande/">Limpieza y mantenimiento</a>
            <a href="/renovatie-inrichting-alhaurin-el-grande/">Reforma y decoración</a>
            <a href="/verhuurlicentie-alhaurin-el-grande/">Licencia de alquiler</a>
            <b>Company</b>
            <a href="/werkwijze/">Cómo trabajamos</a>
            <a href="/over-ons/">Quiénes somos</a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <h1>Disfruta de tu segunda residencia en Alhaurín el Grande. Nosotros nos ocupamos del resto.</h1>
          <p>
            From Villafranco del Guadalhorce and La Cala to Alhaurín el Grande Pueblo, we combine smart rental management with trusted local people. You have one clear contact for bookings, guests, cleaning, maintenance and the day-to-day care of your property.
          </p>
        ...
        <div className="hero-stats">
          ...
          <span>
            <CheckCircle2 aria-hidden="true" />
            <b>Local service</b> in Alhaurín el Grande and the surrounding area
          </span>
        </div>
      </section>
      ...
      <section
        ...
        aria-label="Homes and property in Alhaurín el Grande"
      >
        <figure className="showcase-wide">
          <img
            src="/villa-zwembad-alhaurin-el-grande.webp"
            alt="Modern villa in Alhaurín el Grande with terrace, pool and sea views"
            width="1536"
            height="1024"
            loading="eager"
          />
        ...
        <figure>
          <img
            src="/villa-zwembad-alhaurin-el-grande.webp"
            alt="Holiday home on the Alhaurín el Grande coast"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure>
          <img
            src="/terras-zonsondergang-alhaurin-el-grande.webp"
            alt="Luxury holiday home in Alhaurín el Grande with sea views"
            width="1600"
            height="1200"
            loading="lazy"
          />
      ...
      <aside className="license-note">
        ...
        <a href="/verhuurlicentie-alhaurin-el-grande/">Read about rental licensing →</a>
      </aside>
      ...
      <section className="rental-band">
        ...
        <div className="rental-options">
          <a href="/vakantieverhuur-alhaurin-el-grande/">
          ...
          <a href="/langetermijnverhuur-alhaurin-el-grande/">
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <h2>Conocimiento local en todo Alhaurín el Grande</h2>
          <p>
            From coastal apartments and golf townhouses to hillside villas, we work throughout Alhaurín el Grande Pueblo, La Cala de Alhaurín el Grande, Villafranco del Guadalhorce, Cártama, Miraflores, Alhaurín de la Torre and Alhaurín el Grande Golf.
          </p>
        </div>
        <div className="area-list" aria-label="Areas covered around Alhaurín el Grande">
          <b>Alhaurín el Grande Pueblo</b>
          <b>Villafranco del Guadalhorce</b>
          <b>La Cala de Alhaurín el Grande</b>
          <b>Cártama</b>
          <b>Alhaurín de la Torre</b>
          <b>Alhaurín el Grande Golf</b>
          <b>Fuengirola</b>
          <b>Benalmádena</b>
        </div>
      </section>
      ...
      <section className="home-team">
        <div className="home-team-copy">
          ...
          <h2>Personal contact with people who know Alhaurín el Grande.</h2>
          <p>
      ...
      <section className="knowledge compact-knowledge" id="kennisbank">
        <div className="section-head">
          ...
          <p>
            Clear guidance on costs, rental strategy, regulations and property management in Alhaurín el Grande.
          </p>
        </div>
        <div className="knowledge-grid">
          <a href="/kosten-verhuurbeheer-alhaurin-el-grande/">
            <small>Costs</small>
      ...
      <section className="faq">
        <div>
          ...
          <p>
            Key questions about our services and fees in Alhaurín el Grande.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <section className="contact" id="contact">
        <div>
          ...
          <h2>Recibe una previsión de alquiler para tu vivienda en Alhaurín el Grande</h2>
          <p>
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          <a className="logo-lockup" href="/" aria-label="Home">
            <img
              src="/vbs-logo-alhaurin.webp"
              alt="Property Management Alhaurín el Grande"
              width={640}
              height={640}
              sizes="54px"
            />
            <span>
              Verhuurbeheer <b>Alhaurín el Grande</b>
            </span>
          </a>
          <p>
            Property Management Alhaurín el Grande is part of{" "}
        ...
        <div>
          ...
          <small>© 2026 · Alhaurín el Grande · Costa del Sol</small>
        </div>
      </footer>
      <a
