...
const seoH1BySlug: Record<string, string> = {
  "vakantieverhuur-alhaurin-el-grande": "Vakantieverhuur in Alhaurín el Grande vanaf 18%",
  "midterm-verhuur-alhaurin-el-grande": "Midterm verhuur in Alhaurín el Grande",
  "langetermijnverhuur-alhaurin-el-grande": "Langetermijnverhuur in Alhaurín el Grande",
  "vastgoedbeheer-alhaurin-el-grande": "Vastgoedbeheer in Alhaurín el Grande",
  "schoonmaak-onderhoud-alhaurin-el-grande": "Schoonmaak en onderhoud in Alhaurín el Grande",
  ...
  "verhuurlicentie-alhaurin-el-grande":
    "Verhuurlicentie in Alhaurín el Grande aanvragen en controleren",
  "over-ons": "Over Verhuurbeheer Alhaurín el Grande",
  werkwijze: "Werkwijze voor verhuurbeheer in Alhaurín el Grande",
  contact: "Contact met Verhuurbeheer Alhaurín el Grande",
  "woning-aanmelden": "Woning aanmelden voor verhuurbeheer in Alhaurín el Grande",
  blog: "Blogs over verhuurbeheer in Alhaurín el Grande",
};
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "/alhaurin-el-grande-hero.webp",
          width: 1586,
          height: 992,
    ...
    twitter: {
      ...
      title: p.seoTitle,
      description: p.description,
      images: ["/alhaurin-el-grande-hero.webp"],
    },
  };
}
...
const contentVisualBySlug: Record<string, { src: string; alt: string }> = {
  "vakantieverhuur-alhaurin-el-grande": {
    ...
    alt: "Luxe vakantiewoning in Alhaurín el Grande met lichte woonkamer en uitzicht op zee",
  },
  "midterm-verhuur-alhaurin-el-grande": {
    src: "/luxe-interieur-alhaurin-el-grande.webp",
    alt: "Licht ingericht appartement voor seizoens- en midtermverhuur in Alhaurín el Grande",
  },
  "langetermijnverhuur-alhaurin-el-grande": {
    src: "/luxe-interieur-alhaurin-el-grande.webp",
    alt: "Verzorgd interieur van een woning voor langetermijnverhuur in Alhaurín el Grande",
  },
  "vastgoedbeheer-alhaurin-el-grande": {
    src: "/villa-zwembad-alhaurin-el-grande.webp",
    alt: "Zwembad en mediterrane tuin bij een professioneel beheerde villa in Alhaurín el Grande",
  },
  "schoonmaak-onderhoud-alhaurin-el-grande": {
    src: "/luxe-interieur-alhaurin-el-grande.webp",
    alt: "Schoon en verzorgd interieur van een beheerde woning in Alhaurín el Grande",
  },
  "renovatie-inrichting-alhaurin-el-grande": {
    src: "/terras-zonsondergang-alhaurin-el-grande.webp",
    alt: "Luxe terras van een ingerichte woning in Alhaurín el Grande bij zonsondergang",
  },
  werkwijze: {
    src: "/zonnig-terras-zeezicht-alhaurin-el-grande.webp",
    alt: "Zonnig terras van een beheerde vakantiewoning in Alhaurín el Grande met zeezicht",
  },
};
...
> = {
  "kosten-verhuurbeheer-alhaurin-el-grande": {
    ...
    alt: "Woningen aan zee bij Alhaurín el Grande als illustratie bij de kosten van verhuurbeheer",
    category: "Kosten & tarieven",
    readTime: "4 min",
  },
  "dynamische-prijzen-vakantiewoning": {
    src: "/luxe-woning-alhaurin-el-grande-zeezicht.webp",
    alt: "Luxe vakantiewoning met zeezicht in Alhaurín el Grande voor een blog over dynamische prijzen",
    category: "Opbrengst",
    readTime: "4 min",
  },
  "zelf-verhuren-of-verhuurbeheer": {
  ...
  "verhuurlicentie-alhaurin-el-grande": {
    src: "/alhaurin-el-grande-hero.webp",
    alt: "Uitzicht over Alhaurín el Grande bij informatie over de verhuurlicentie",
...
export default async function ContentRoute({
  ...
  const organization = {
    ...
    logo: {
      "@type": "ImageObject",
      url: absoluteUrl("/vbs-logo-alhaurin.webp"),
    },
  };
  const pageSchema =
    page.type === "gids"
  ...
  const trustItems =
    page.slug === "langetermijnverhuur-alhaurin-el-grande"
      ? [
          <>
      ...
      : page.slug === "vastgoedbeheer-alhaurin-el-grande"
        ? [
            <>
    ...
    <main className="content-page" id="top">
      ...
      <section className="content-hero">
        ...
        <aside>
          ...
          <strong>{page.price ?? "Alhaurín el Grande · Costa del Sol"}</strong>
          <p>
        ...
        <section className="signup-experience" id="woningformulier">
          <div className="signup-story">
            ...
            <div className="signup-photo">
              ...
              <span>Alhaurín el Grande · Costa del Sol</span>
            </div>
          ...
          <FormSubmit className="signup-form" action={leadFormAction} thankYouPath={siteConfig.template.thankYouPath}>
            ...
            <label>Locatie woning<input name="locatie" placeholder="Bijv. Alhaurín el Grande, Coín of Cártama" required /></label>
        ...
        <section className="contact contact-page-form" id="woningformulier">
          ...
          <FormSubmit action={leadFormAction} thankYouPath={siteConfig.template.thankYouPath}>
            ...
            <label>
              ...
              <input
                name="locatie"
                placeholder="Bijv. Alhaurín el Grande of Coín"
                required
              />
            </label>
            <label>
      ...
      {page.slug === "blog" && featuredBlog ? (
        <section
          ...
          aria-label="Alle blogs over verhuurbeheer in Alhaurín el Grande"
        >
      ...
      {page.slug === "verhuurlicentie-alhaurin-el-grande" && (
      ...
      {page.slug !== "blog" && page.slug !== "contact" && page.slug !== "woning-aanmelden" && (
        <section className="related">
          ...
          <h2>Meer voor eigenaren in Alhaurín el Grande</h2>
          <div>
            {related.map((r) => (
        ...
        <section className="blog-lead">
          ...
          >
            ...
            <label>
              ...
              <input
                name="locatie"
                placeholder="Bijv. Alhaurín el Grande, Coín of Cártama"
              />
            </label>
            <label className="wide">
              Je vraag
      ...
      <footer className="site-footer">
        ...
        <div>
          ...
          <a href="/vastgoedbeheer-alhaurin-el-grande/">Vastgoedbeheer</a>
          <a href="/verhuurlicentie-alhaurin-el-grande/">Verhuurlicentie</a>
          <a href="/nederlandse-verhuurmakelaar-alhaurin-el-grande/">Nederlandse verhuurmakelaar</a>
          <a href="/sleutelbeheer-alhaurin-el-grande/">Sleutelbeheer</a>
          <a href="/appartement-verhuren-alhaurin-el-grande/">Appartement verhuren</a>
          <a href="/villa-verhuren-alhaurin-el-grande/">Villa verhuren</a>
          <a href="/airbnb-beheer-alhaurin-el-grande/">Airbnb & Booking beheer</a>
          <a href="/tweede-woning-beheer-alhaurin-el-grande/">Tweede woning beheer</a>
        </div>
        <div>
          <b>Meer</b>
          <a href="/werkwijze/">Werkwijze</a>
