...
export const metadata: Metadata = {
  title: "Bedankt voor je aanvraag | Verhuurbeheer Alhaurín el Grande",
...
export default function BedanktPage() {
  return (
    <main className="thanks-page">
      ...
      <a className="thanks-logo" href="/" aria-label="Terug naar Verhuurbeheer Alhaurín el Grande">
        <img src="/vbs-logo-alhaurin.webp" alt="Verhuurbeheer Alhaurín el Grande" width="62" height="62" />
      </a>
      ...
      <p className="thanks-footer">Verhuurbeheer Alhaurín el Grande · Costa del Sol</p>
    </main>
  );
}
