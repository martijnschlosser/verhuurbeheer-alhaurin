...
const services = [
  {
    ...
    icon: BedDouble,
    text: "Van finca of villa tot appartement: we regelen presentatie, boekingskanalen, prijsstrategie, gastencontact en de uitvoering rond ieder verblijf.",
  },
  {
  ...
  },
  {
    ...
    price: "Maatwerk",
    icon: ShieldCheck,
    text: "Lokale woningchecks, sleutelbeheer en toegang voor leveranciers in Alhaurín el Grande wanneer je zelf niet in Spanje bent.",
  },
  {
    ...
    icon: Sparkles,
    text: "Wisselschoonmaak, linnen, inspecties en coördinatie van onderhoud door lokale partners rond Alhaurín el Grande.",
  },
  {
...
const faqs = [
  [
    "Wat kost vakantieverhuurbeheer in Alhaurín el Grande?",
  ...
  [
    "In welke delen van Alhaurín el Grande zijn jullie actief?",
    "We ondersteunen eigenaren in Alhaurín el Grande en omliggende delen van de Valle del Guadalhorce, waaronder Villafranco del Guadalhorce, Coín en Cártama. We bekijken per woning wat praktisch haalbaar is.",
  ],
  [
    "Heb ik een verhuurlicentie nodig voor vakantieverhuur in Alhaurín el Grande?",
...
export default function Home() {
  ...
  const schema = {
    ...
    description:
      "Nederlandstalig fullservice verhuurbeheer, vakantieverhuurbeheer en vastgoedbeheer voor woningeigenaren in Alhaurín el Grande.",
    parentOrganization: {
      "@type": "Organization",
    ...
    <main>
      ...
      <header className="site-header">
        <a
          ...
          href="/"
          aria-label="Verhuurbeheer Alhaurín el Grande – naar Home"
        >
          <img
            src="/vbs-logo-alhaurin.webp"
            alt="Logo Verhuurbeheer Alhaurín el Grande"
            width="54"
            height="54"
          />
        </a>
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-alhaurin-el-grande/">Vakantieverhuur</a>
              <a href="/midterm-verhuur-alhaurin-el-grande/">
                Seizoens- en midtermverhuur
              </a>
              <a href="/langetermijnverhuur-alhaurin-el-grande/">Langetermijnverhuur</a>
              <a href="/vastgoedbeheer-alhaurin-el-grande/">Vastgoedbeheer</a>
              ...
              <a href="/verhuurlicentie-alhaurin-el-grande/">Verhuurlicentie</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Diensten</b>
            <a href="/vakantieverhuur-alhaurin-el-grande/">Vakantieverhuur</a>
            <a href="/midterm-verhuur-alhaurin-el-grande/">Seizoens- en midtermverhuur</a>
            <a href="/langetermijnverhuur-alhaurin-el-grande/">Langetermijnverhuur</a>
            <a href="/vastgoedbeheer-alhaurin-el-grande/">Vastgoedbeheer</a>
            <a href="/schoonmaak-onderhoud-alhaurin-el-grande/">Schoonmaak & onderhoud</a>
            <a href="/renovatie-inrichting-alhaurin-el-grande/">Renovatie & inrichting</a>
            <a href="/verhuurlicentie-alhaurin-el-grande/">Verhuurlicentie</a>
            <b>Bedrijf</b>
            <a href="/werkwijze/">Werkwijze</a>
            <a href="/over-ons/">Over ons</a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <h1>Geniet van je tweede huis in Alhaurín el Grande, wij regelen de rest.</h1>
          <p>
      ...
      <section
        ...
        aria-label="Mediterrane woningen en sfeer in Alhaurín el Grande"
      >
        <figure className="showcase-wide">
          <img
            src="/vastgoed-aan-zee-alhaurin-el-grande.webp"
            alt="Mediterrane woning in de regio Alhaurín el Grande"
            width="1200"
            height="800"
            loading="eager"
          />
        ...
        <figure className="showcase-pool">
          <img
            ...
            alt="Zwembad met palmen en mediterrane tuin bij een villa in Alhaurín el Grande"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure className="showcase-garden">
          <img
            src="/urbanisatie-zwembad-alhaurin-el-grande.webp"
            alt="Witte urbanisatie met groene tuin en zwembad in Alhaurín el Grande"
            width="1600"
            height="1067"
            loading="lazy"
          />
        ...
        <figure className="showcase-terrace">
          <img
            src="/zonnig-terras-zeezicht-alhaurin-el-grande.webp"
            alt="Zonnig terras met zeezicht in Alhaurín el Grande"
            width="1600"
            height="1067"
            loading="lazy"
          />
      ...
      <section className="services" id="diensten">
        <div className="section-head">
          ...
          <h2>Alles voor je woning in Alhaurín el Grande</h2>
          <p>
      ...
      <aside className="license-note">
        ...
        <a href="/verhuurlicentie-alhaurin-el-grande/">Lees over de verhuurlicentie →</a>
      </aside>
      ...
      <section className="owner-experience" aria-label="De beleving van professioneel woningbeheer">
        ...
        <figure className="owner-experience-main">
          <img
            src="/woning-alhaurin-el-grande-zeezicht.webp"
            alt="Verzorgde woning in Alhaurín el Grande met uitzicht op zee"
            width="1200"
            height="800"
            loading="lazy"
          />
        ...
        <figure className="owner-experience-detail">
          <img
            src="/woning-interieur-alhaurin-el-grande.webp"
            alt="Licht en verzorgd interieur van een woning in Alhaurín el Grande"
            width="1200"
            height="800"
            loading="lazy"
          />
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <h2>Lokaal actief in Alhaurín el Grande en de Guadalhorce-vallei</h2>
          <p>
            Van het centrum en Villafranco del Guadalhorce tot Coín, Cártama en
            omliggende buitengebieden met finca's en villa's.
          </p>
        </div>
        <div className="area-list" aria-label="Werkgebieden rond Alhaurín el Grande">
          <b>Alhaurín el Grande Centrum</b>
          <b>Villafranco del Guadalhorce</b>
          <b>Coín</b>
          <b>Cártama</b>
          <b>Alhaurín de la Torre</b>
          <b>Valle del Guadalhorce</b>
        </div>
      </section>
      ...
      <section className="knowledge compact-knowledge" id="kennisbank">
        <div className="section-head">
          ...
          <p>
            ...
            vastgoedbeheer in Alhaurín el Grande.
          </p>
        </div>
      ...
      <section className="faq">
        <div>
          ...
          <p>
            De belangrijkste vragen over onze diensten en tarieven in Alhaurín el Grande.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <section className="home-owner-cta" id="woning-aanmelden">
        <div className="home-owner-cta-image" role="img" aria-label="Zonnig terras met uitzicht op zee in Alhaurín el Grande" />
        <div className="home-owner-cta-copy">
          <p className="kicker orange">Vrijblijvend kennismaken</p>
          <h2>Klaar om meer uit je woning in Alhaurín el Grande te halen?</h2>
          <p>
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          ...
          <p>
            Verhuurbeheer Alhaurín el Grande is onderdeel van{" "}
